...
//@SpringApplicationConfiguration(classes = {MyApp.class,TestConfiguration.class})
...
public class ActivityProcessTest {
    ...
    public void testHappyPath() {
        ...
        //Assert.assertTrue(runtimeService.getActiveActivityIds(processInstance.getId())).containsOnly("sid-C2137C46-166B-4F9B-92A1-97BF920FCD9E0");
        ...
        /*final Execution forkA = runtimeService
                .createExecutionQuery()
                .activityId("sid-C2137C46-166B-4F9B-92A1-97BF920FCD9E")
                .processInstanceId(processInstance.getId())
                .singleResult();
